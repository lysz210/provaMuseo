var notepad={
	padHTML:'<div class="notepad"><span class="close" title="Close Notepad">X</span><h3 class="title">Benvenuto utente!</h3>'
				+'<p>Grazie per essere entrato e buon divertimento!.</p>'
				+'<form></form>'
				+'</div>',

	noteHTML:'<b>Ricordati che siamo in Beta quindi non spaventarti di nulla!</b>',
	...
	loadpad:function(id, position){
		...
		function positionpad(x,y){ //private position function
			...
			var xpos=(x=="center")? windowmeasure.w/10-paddimensions.w/5 : (x=="left")? 2 : (x=="right")? windowmeasure.w-paddimensions.w-50 : parseInt(x)
			var ypos=(y=="center")? windowmeasure.h/10-paddimensions.h/5 : (y=="top")? 2 : (y=="bottom")? windowmeasure.h-paddimensions.h-50 : parseInt(y)
